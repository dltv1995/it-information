/* ============================================================
   แก้ไขง่าย: แก้เฉพาะรายการด้านล่าง
   - title      ชื่อหน่วยงาน
   - mindFile   ตำแหน่งไฟล์ .mind ของหน่วยงานนั้น
   - driveUrl   ลิงก์แชร์ Google Drive
   - logo       รูปโลโก้สำหรับแสดงในหน้าเลือก (ไม่ใส่ก็ได้)
   แต่ละไฟล์ .mind ต้อง Compile จากโลโก้เพียง 1 ภาพ จึงใช้ targetIndex: 0
   ============================================================ */
window.AR_AGENCIES = [
  {
    title: "หน่วยงานที่ 1",
